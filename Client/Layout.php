...
<body>
    ...
    <div class="top-navbar">
        ...
        <?php if(!isset($_GET["Login"])) {?>
            ...
            <button id="btn-signup"><a href="inscription.php">S'inscrire</a></button>
            <i class="fa-solid fa-user"></i>
            <?php }?>
            <?php if(isset($_GET["Login"])) 
            { ?>
                <button id="btn-signup"><a href="connexion.php">Se déconnecter</a></button>
            <a href="../controllers/remplir1.php?action1=profile &id=<?php if(isset($_GET["id"])) echo $_GET["id"];?>" ><i class="fa-solid fa-user"></i></a>   
            <?php  echo $_GET["Login"];
            } ?>
    ...
    <div class="home-section">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="catalogue_par_categorie.php?id="<?php if(isset($_GET["id"])) echo $_GET["id"] ?>>Produits</a>
                        </li>
                        <li class="nav-item">
        ...
        <div id ="divCat"></div>
        <div id="divProduits"><?php  require("../controllers/All.php");?>
